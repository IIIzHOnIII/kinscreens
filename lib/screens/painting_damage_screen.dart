...
class _DamageScreenState extends State<DamageScreen> {
  ...
  bool hasFractures = false;
  bool hasHumidityStains = false;
  bool hasPastePeeling = false;
  bool hasOtherDamages = false;
  File? _selectedImage;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildCheckbox(
            title: 'Tonalidades diferentes por humedad',
            value: hasHumidityStains,
            onChanged: (value) {
              setState(() {
                hasHumidityStains = value!;
              });
            },
          ),
          _buildCheckbox(
            title: 'Desprendimientos de pastas',
            value: hasPastePeeling,
            onChanged: (value) {
              setState(() {
                hasPastePeeling = value!;
              });
            },
          ),
          _buildCheckbox(
            title: 'Otros',
            value: hasOtherDamages,
            onChanged: (value) {
              setState(() {
                hasOtherDamages = value!;
              });
            },
          ),
        ],
