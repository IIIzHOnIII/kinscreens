...
class PaintingServices extends StatelessWidget {
  ...
  Widget _buildImageInWave() {
    return ClipRRect(
      ...
      child: Image.asset(
        'images/615611.jpg', // Imagen para esta pantalla
        height: 280,
        fit: BoxFit.cover,
      ),
    );
    ...
    final services = [
      {
        ...
        "route": "/painting_application"
      },
      {
        "text": "IMPERMEABILIZACIÓN (CORRECCIÓN DE FILTRACIONES)",
        "icon": Icons.water_damage,
        "route": "/painting_waterproofing"
      },
      {
        "text": "REVESTIMIENTOS",
        "icon": Icons.layers,
        "route": "/painting_coatings"
      },
    ];
