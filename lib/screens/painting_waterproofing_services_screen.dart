...
class WaterproofingServices extends StatelessWidget {
  const WaterproofingServices({super.key});
  ...
  Widget _buildImageInWave() {
    return ClipRRect(
      ...
      child: Image.asset(
        'images/98268.jpg', // Imagen para esta pantalla
        height: 280,
        fit: BoxFit.cover,
      ),
    );
    ...
    final services = [
      {
        ...
        "route": "/painting_waterproofing_wall_screen",
      },
      {
        "text": "LOZAS",
        "icon": Icons.roofing,
      ...
      {
        "text": "JARDINERAS / FUGAS / OTROS",
        "icon": Icons.grass,
        "route": "/waterproofing_jardineras",
      },
    ];
